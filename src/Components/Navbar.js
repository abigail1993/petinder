        ...
        return(
            <nav className = 'App-container-fluid align-bottom'>
                <div className = 'row justify-content-start'>
                    ...
                    <div className = 'col-3 text-center'><Link to='/Matches'><i className="fas fa-paw"></i></ Link></div>
                    <div className = 'col-3 text-center'><Link to='/LogOut'><i className="fas fa-sign-out-alt"></i></ Link></div>
                </div>
            </nav>
        )
    }
